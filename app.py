            ...
            if bad:
                ...
                st.markdown(f'''<div style="background:#FCEDED;border:1.5px solid #E4B4B4;border-radius:10px;
                  ...
                  <div style="font-family:'Source Serif 4',Georgia,serif;font-size:14.5px;color:#7A3A3A;
                    line-height:1.6">{who} would be left without enough players to put out a legal side.
                    They would be short of a batting position or a bowling phase that the rules require
                    them to cover. Send back a player who can fill that gap, or take fewer players away,
                    and the deal becomes possible.</div></div>''', unsafe_allow_html=True)
            else:
