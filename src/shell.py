...
.rk td{padding:9px 10px;text-align:right;border-bottom:1px solid #EDEAE0;font-variant-numeric:tabular-nums}
.rk td:first-child{text-align:left;color:#8A9490;font-size:11.5px;width:38px}
.rk td:nth-child(2){text-align:left;font-weight:600;color:#16281C}
...
def hero():
    ...
    st.markdown(f"""<div class="hero">{img}<div class="sh"></div>
      ...
      <div class="ct"><div class="bn">IPL Trade Values</div>
        ...
        <div class="byl">by Omkar Walunj</div>
