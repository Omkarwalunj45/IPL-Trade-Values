...
/* Hero sits on a photo, so its text must stay white. These selectors are written
   at higher specificity than the global .stApp rules above, otherwise the global
   dark-green colour wins and the masthead disappears into the image. */
.stApp .hero,.stApp .hero *,.stApp .hero div,.stApp .hero span,.stApp .hero b,
html body .hero,html body .hero *{color:#fff!important;-webkit-text-fill-color:#fff!important}
.stApp .hero .bn,html body .hero .bn{color:#fff!important;-webkit-text-fill-color:#fff!important;
  text-shadow:0 2px 26px rgba(0,0,0,.75),0 1px 3px rgba(0,0,0,.6)!important}
.stApp .hero .tl,html body .hero .tl{color:#EAF4EC!important;-webkit-text-fill-color:#EAF4EC!important;
  text-shadow:0 1px 10px rgba(0,0,0,.7)!important}
.stApp .hero .byl,html body .hero .byl{color:#F4F1E6!important;-webkit-text-fill-color:#F4F1E6!important;
  text-shadow:0 1px 10px rgba(0,0,0,.7)!important}
.stApp .hero .au b,html body .hero .au b{color:#fff!important;-webkit-text-fill-color:#fff!important}
.stApp .hero .au a,html body .hero .au a{color:rgba(255,255,255,.78)!important;
  -webkit-text-fill-color:rgba(255,255,255,.78)!important}
.stApp .hero .au a:hover{color:#fff!important;-webkit-text-fill-color:#fff!important}
...
.hero .sh{position:absolute;inset:0;background:linear-gradient(180deg,rgba(6,20,14,.62) 0%,
  rgba(6,20,14,.52) 45%,rgba(6,20,14,.78) 100%)}
